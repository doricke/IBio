...
class AlgorithmsControllerTest < ActionController::TestCase
  ...
  test "should create algorithm" do
    assert_difference('Algorithm.count') do
      post :create, algorithm: { algorithm_name: @algorithm.algorithm_name, updated_at: @algorithm.updated_at, version: @algorithm.version }
    end
  ...
  test "should update algorithm" do
    patch :update, id: @algorithm, algorithm: { algorithm_name: @algorithm.algorithm_name, updated_at: @algorithm.updated_at, version: @algorithm.version }
    assert_redirected_to algorithm_path(assigns(:algorithm))
  end
