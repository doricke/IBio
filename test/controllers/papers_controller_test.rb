...
class PapersControllerTest < ActionController::TestCase
  ...
  test "should create paper" do
    assert_difference('Paper.count') do
      post :create, paper: { authors: @paper.authors, doi: @paper.doi, pmid: @paper.pmid, reference: @paper.reference, title: @paper.title }
    end
  ...
  test "should update paper" do
    patch :update, id: @paper, paper: { authors: @paper.authors, doi: @paper.doi, pmid: @paper.pmid, reference: @paper.reference, title: @paper.title }
    assert_redirected_to paper_path(assigns(:paper))
  end
