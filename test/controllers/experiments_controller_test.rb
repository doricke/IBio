...
class ExperimentsControllerTest < ActionController::TestCase
  ...
  test "should create experiment" do
    assert_difference('Experiment.count') do
      post :create, experiment: { created_at: @experiment.created_at, instrument_id: @experiment.instrument_id, name: @experiment.name, note_id: @experiment.note_id, type_id: @experiment.type_id }
    end
  ...
  test "should update experiment" do
    patch :update, id: @experiment, experiment: { created_at: @experiment.created_at, instrument_id: @experiment.instrument_id, name: @experiment.name, note_id: @experiment.note_id, type_id: @experiment.type_id }
    assert_redirected_to experiment_path(assigns(:experiment))
  end
